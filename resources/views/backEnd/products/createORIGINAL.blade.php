            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('short')?' has-error':''}}">
                            <input type="text" name="short" id="short" class="form-control" value="{{old('short')}}" title=""  style="width: 400px;">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('p_color')?' has-error':''}}">
                            <input type="text" name="p_color" id="p_color" value="{{old('p_color')}}"  style="width: 400px;">
